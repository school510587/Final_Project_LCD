...
#Source Files
SRC += system_stm32f4xx.c startup_stm32f4xx.s ./LCD/LCD.c ./clib/__internal__.c ./clib/memory.c ./clib/string.c $(LIB_STM)/Utilities/STM32F4-Discovery/stm32f4_discovery.c \
